...
export async function onRequestPut(context) {
    ...
    if (contentType != null) {
        ...
        if (theItem != null) {
            ...
            //save it
            await KV.put(datamain + "-" + user.user.secret + "]" + payLoad.id, JSON.stringify(theDataArray));
            return new Response(JSON.stringify({ message: "Item updated", data: JSON.stringify(theDataArray) }), { status: 200 });
